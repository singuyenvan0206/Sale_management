    ...
    public class CustomerService : ICustomerService
    {
        ...
        public async Task<int> GetOrCreateCustomerIdAsync(string name, string phone, string email, string address)
        {
            ...
            var newCustomer = new Customer
            {
                ...
                Email = email,
                Address = address,
                CustomerType = ShopManager.Core.Enums.CustomerType.Regular.ToDbString(),
                Points = 0
            };
        ...
        public static bool DeleteAllCustomers()
        {
            try
            {
                const string sql = @"
                    ...
                    WHERE i.Id IS NULL;";
                using var connection = new MySql.Data.MySqlClient.MySqlConnection(ShopManager.Core.Settings.SettingsManager.BuildConnectionString());
                connection.Open();
