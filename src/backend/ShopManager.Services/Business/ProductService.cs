...
using ShopManager.Core.Utils;
using Microsoft.Extensions.DependencyInjection;

namespace ShopManager.Services
{
    public class ProductService : ShopManager.Core.Interfaces.IProductService
    {
        private readonly IProductRepository _productRepository;
        private readonly ICacheService _cacheService;
        private readonly ShopManager.Core.Interfaces.INotificationService _notificationService;
        private const string CacheKey = "AllProductsWithCategories";

        public ProductService(
            IProductRepository productRepository, 
            ICacheService cacheService, 
            ShopManager.Core.Interfaces.INotificationService notificationService)
        {
