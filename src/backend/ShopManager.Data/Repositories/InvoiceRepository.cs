    ...
    public class InvoiceRepository : MySqlRepositoryBase, IInvoiceRepository
    {
        ...
        public async Task<bool> SaveInvoiceAsync(Invoice invoice, int? voucherId)
        {
            ...
            try
            {
                ...
                var settings = ShopManager.Core.Models.TierSettingsManager.Load();
                ...
                await connection.ExecuteAsync(updateCustLoyalty, new
                {
                    ...
                    VIPStr = ShopManager.Core.Enums.CustomerType.VIP.ToDbString(),
                    GoldStr = ShopManager.Core.Enums.CustomerType.Gold.ToDbString(),
                    SilverStr = ShopManager.Core.Enums.CustomerType.Silver.ToDbString(),
                    RegularStr = ShopManager.Core.Enums.CustomerType.Regular.ToDbString()
                }, transaction: tx);
                // --------------------------------------------------------
