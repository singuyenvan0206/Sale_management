...
namespace ShopManager.App.ViewModels
{
    public class UserManagementViewModel : BaseViewModel
    {
        ...
        public List<string> RoleFilters { get; } = new() { "", UserRole.Admin.ToRoleString(), UserRole.Manager.ToRoleString(), UserRole.Cashier.ToRoleString() };
        ...
        private async System.Threading.Tasks.Task LoadAsync()
        {
            ...
            {
                StatusText = "Đang tải...";
                var accounts = await System.Threading.Tasks.Task.Run(() => UserService.GetAllAccounts());
                
                var users = await System.Threading.Tasks.Task.Run(() =>
                    accounts.Select(a => new UserManagementItem
                    {
                        Id = a.Id,
                        Username = a.Username,
