...
namespace ShopManager.App.ViewModels
{
    public class VoucherManagementViewModel : BaseViewModel
    {
        ...
        // -------- Filter Options --------
        public List<string> ActiveFilterOptions { get; } = new() { nameof(ShopManager.Core.Enums.VoucherActiveFilter.All), nameof(ShopManager.Core.Enums.VoucherActiveFilter.Active), nameof(ShopManager.Core.Enums.VoucherActiveFilter.Inactive) };
        public List<string> DiscountTypeFilterOptions { get; } = new() { "All", "VND", "Percent" };
        public List<string> ValidityFilterOptions { get; } = new() { nameof(ShopManager.Core.Enums.VoucherValidityFilter.All), nameof(ShopManager.Core.Enums.VoucherValidityFilter.ValidNow), nameof(ShopManager.Core.Enums.VoucherValidityFilter.Expired), nameof(ShopManager.Core.Enums.VoucherValidityFilter.Upcoming) };
        public List<string> UsageFilterOptions { get; } = new() { nameof(ShopManager.Core.Enums.VoucherUsageFilter.All), nameof(ShopManager.Core.Enums.VoucherUsageFilter.Available), nameof(ShopManager.Core.Enums.VoucherUsageFilter.FullyUsed) };
        ...
        private void ApplyFilters()
        {
            _pagination.SetFilter(v =>
            {
                ...
                {
                    nameof(ShopManager.Core.Enums.VoucherActiveFilter.Active) => v.IsActive,
                    nameof(ShopManager.Core.Enums.VoucherActiveFilter.Inactive) => !v.IsActive,
                    _ => true
                };
                bool matchesType = DiscountTypeFilter switch
                {
                    "VND" => ShopManager.Core.Enums.VoucherDiscountTypeExtensions.ParseVoucherDiscountType(v.DiscountType) == ShopManager.Core.Enums.VoucherDiscountType.FixedAmount,
                    "Percent" => ShopManager.Core.Enums.VoucherDiscountTypeExtensions.ParseVoucherDiscountType(v.DiscountType) == ShopManager.Core.Enums.VoucherDiscountType.Percentage,
                    _ => true
                };
                var now = DateTime.Now;
                bool matchesValidity = ValidityFilter switch
                {
                    nameof(ShopManager.Core.Enums.VoucherValidityFilter.ValidNow) => v.StartDate <= now && v.EndDate >= now,
                    nameof(ShopManager.Core.Enums.VoucherValidityFilter.Expired) => v.EndDate < now,
                    nameof(ShopManager.Core.Enums.VoucherValidityFilter.Upcoming) => v.StartDate > now,
                    _ => true
                };
                bool matchesUsage = UsageFilter switch
                {
                    nameof(ShopManager.Core.Enums.VoucherUsageFilter.Available) => v.UsedCount < v.UsageLimit,
                    nameof(ShopManager.Core.Enums.VoucherUsageFilter.FullyUsed) => v.UsedCount >= v.UsageLimit,
                    _ => true
                };
