...
namespace FashionStore.Services
{
    public class CategoryService : ICategoryService
    {
        ...
        private static ICategoryService GetService() => ServiceLocator.ServiceProvider?.GetRequiredService<ICategoryService>() ?? throw new InvalidOperationException("DI not initialized");
