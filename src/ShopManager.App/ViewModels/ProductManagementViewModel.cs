...
namespace ShopManager.App.ViewModels
{
    ...
    public class ProductManagementViewModel : BaseViewModel
    {
        ...
        public void LoadData() => _ = LoadDataAsync();
        private void LoadProducts() => LoadData();
        ...
        public async System.Threading.Tasks.Task LoadDataAsync()
        {
            ...
            try
            {
                var categoriesTask = System.Threading.Tasks.Task.Run(() => CategoryService.GetAllCategories());
                ...
                var activePromosTask = System.Threading.Tasks.Task.Run(() => { try { return PromotionService.GetActivePromotions(); } catch { return new List<Promotion>(); } });

                await System.Threading.Tasks.Task.WhenAll(categoriesTask, suppliersTask, productsTask, activePromosTask);

                var cats = categoriesTask.Result;
                var sups = suppliersTask.Result;
                var products = productsTask.Result;
                var activePromos = activePromosTask.Result;
            ...
            {
                StatusText = "Lỗi tải dữ liệu";
                AppLogger.Log(ex, "ProductManagementViewModel.LoadDataAsync");
            }
        }
