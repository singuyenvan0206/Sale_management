...
namespace FashionStore.Services
{
    public class VoucherService : IVoucherService
    {
        ...
        private static IVoucherService GetService() => App.ServiceProvider?.GetRequiredService<IVoucherService>() ?? throw new InvalidOperationException("DI not initialized");
